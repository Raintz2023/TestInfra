module Receiver(
    ...
    output      wire        [ 0 : 0]        START_BIT,
    output      wire        [ 0 : 0]        STOP_BIT,
    ...
    assign START_BIT  = (current_state != BUSY_STATE)? pipe[9]: 1'b1;
    assign STOP_BIT = (current_state != BUSY_STATE)? pipe[0]: 1'b0;
    ...
    assign DATA = (START_BIT == 1'b0 && STOP_BIT == 1'b1)? DOUT_TEMP: 8'b11111111;
